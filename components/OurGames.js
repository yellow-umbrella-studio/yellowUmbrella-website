...
const games = [
  ...
  },
  {
    ...
    appStore:
      "https://apps.apple.com/us/app/cars-quiz-car-trivia-game/id6670433734",
    playStore:
      "https://play.google.com/store/apps/details?id=com.yellowUmbrella.carTrivia",
  },
  {
    id: 4,
    title: "Netflix Quiz",
    ...
    appStore: null,
    appStore:
      "https://apps.apple.com/us/app/netquiz-tv-shows-trivia/id6736584614",
    playStore:
      "https://play.google.com/store/apps/details?id=com.yonigold.NetflixQuiz",
  },
];

const GameCard = ({ game }) => (
  <div className="flex flex-col items-center space-y-4 bg-gray-100 p-6 rounded-xl w-80 mx-auto">
    {" "}
    ...
    <div className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {" "}
          {/* Adjusted gap and added more columns for larger screens */}
          {games.map((game) => (
